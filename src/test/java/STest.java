...
class STest {
    ...
    private static final String SOURCE_FILE = "src/main/java/S.java";
    ...
    @Test
    void Java_1_0_source_code_outputs_itself() throws IOException {
    ...
    @Test
    void file_length_is_shortest_Java_1_0_code_that_outputs_itself() {
